    ...
    <div class="container py-4">
        ...
        <div class="glass-card mb-4 d-flex flex-column flex-md-row align-items-center align-items-md-start">
            <div class="text-center me-md-5 mb-4 mb-md-0">
                <img src="{{ $tenant->image_path ?? 'https://ui-avatars.com/api/?name='.urlencode($tenant->name) }}" alt="Profile Photo" class="rounded-circle profile-img-lg">
            ...
            <div class="flex-grow-1">
                <ul class="info-list">
                    ...
                    <li><span class="info-label">Occupation:</span><span class="info-value">{{ $tenant->occupation }}</span></li>
                    <li><span class="info-label">ID Number:</span><span class="info-value">{{ $tenant->id_number }}</span></li>
                    <li><span class="info-label">ID Type:</span><span class="info-value">{{ $tenant->id_type }}</span></li>
                    <li><span class="info-label">Date of Birth:</span><span class="info-value">{{ $tenant->date_of_birth }}</span></li>
                    <li><span class="info-label">Created At:</span><span class="info-value">{{ $tenant->created_at }}</span></li>
                    <li><span class="info-label">Updated At:</span><span class="info-value">{{ $tenant->updated_at }}</span></li>
                </ul>
            </div>
        </div>
    </div>
