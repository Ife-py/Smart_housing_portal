    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="property-card h-100 border-0">
                <a href="{{ route('dashboard.tenant.properties.show', $property) }}">
                ...
                <div class="p-3">
                    ...
                    <a href="{{ route('dashboard.tenant.properties.show', $property) }}" class="btn btn-outline-info btn-sm w-100">View Details</a>
                </div>
            </div>
        </div>
        @empty
