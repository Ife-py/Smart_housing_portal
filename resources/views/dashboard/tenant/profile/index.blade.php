    ...
    <div class="tenant-welcome d-flex align-items-center mb-4">
        <div class="me-4">
            @if ($tenant->image_path)
                <a href="{{ asset('storage/' . $tenant->image_path) }}" data-lightbox="tenant-{{ $tenant->id }}" data-title="{{ $tenant->name }}">
                    <img src="{{ asset('storage/' . $tenant->image_path) }}" alt="{{ $tenant->name }}"
                        class="rounded-circle profile-img-lg" style="cursor: pointer; width: 100px; height: 100px; object-fit: cover;">
                </a>
            @else
                <img src="https://ui-avatars.com/api/?name={{ urlencode($tenant->name) }}" 
                     alt="{{ $tenant->name }}" 
        ...
        <form>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $tenant->gender ?? 'Not Provided' }}" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $tenant->address ?? 'Not Provided' }}" readonly>
                </div>
                <div class="col-md-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $tenant->occupation ?? 'Not Provided' }}" readonly>
                </div>
            </div>
