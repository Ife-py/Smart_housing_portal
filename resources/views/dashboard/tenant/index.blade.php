                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="property-card h-100 border-0">
                                <img src="{{ $property['img'] }}" class="card-img-top" alt="{{ $property['title'] }}"
                                    style="height: 140px; object-fit: cover; border-radius: 1.2rem 1.2rem 0 0;">
                                <div class="card-body">
                                    <h5 class="card-title mb-1">{{ $property['title'] }}</h5>
                                    <div class="text-muted small mb-2"><i
                                            class="fa fa-map-marker-alt me-1"></i>{{ $property['location'] }}</div>
                                    <div class="fw-semibold text-primary mb-2">{{ $property['price'] }}</div>
                                    <a href="" class="btn btn-outline-primary btn-sm w-100 quick-action-btn">View
                                        Details</a>
                                </div>
                            </div>
                        </div>
