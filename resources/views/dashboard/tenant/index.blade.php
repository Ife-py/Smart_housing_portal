    ...
    <div class="tenant-welcome mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="{{ route('dashboard.tenant.my_properties.index') }}" class="btn btn-light quick-action-btn me-2"><i
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="property-card border-0 h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('dashboard.tenant.properties.show', $property->id) }}"
